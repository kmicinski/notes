...
type: paper
bibtex: |
  @inproceedings{relational-Joins-GPU,
  	...
  	pages = {511–524},
  	numpages = {14},
  	keywords = {sort, primitive, parallel processing, relational database, graphics processors, join},
  	location = {Vancouver, Canada},
  	series = {SIGMOD '08}
  }
doi: 10.1145/1376616.1376670

pdf: relational-Joins-GPU.pdf
---
